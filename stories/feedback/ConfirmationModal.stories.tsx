...
import { Button, Icon, IconNames, Modal, ConfirmModalProps } from '../../src';
...
const meta: Meta<ConfirmModalProps> = {
  ...
  argTypes: {
    ...
    confirmText: {
      control: 'text',
      description:
        'The text to be displayed on the confirm button (default is "Confirm").',
      table: {
        type: { summary: 'string' },
      },
    },
    cancelText: {
      control: 'text',
      description:
        'The text to display on the cancel button (default is "Cancel").',
      table: {
        type: { summary: 'string' },
      },
    },
