...
import { Icon, Tooltip, TooltipProps } from '../../src/components';
...
const meta: Meta<TooltipProps> = {
    ...
    argTypes: {
        ...
        mouseEnterDelay: {
            control: 'number',
            description: 'Delay before tooltip is shown when mouse enters the content.',
            table: {
        ...
        mouseLeaveDelay: {
            control: 'number',
            description: 'Delay before tooltip is hidden when mouse leaves the content.',
            table: {
