...
const meta: Meta<TableProps<any>> = {
    ...
    argTypes: {
        columns: {
            control: false,
            description: 'An array of column configurations, where each column can define its label, key, filter type, sortability, and rendering logic.',
            table: {
        ...
        data: {
            control: 'object',
            description: 'The array of data rows to display in the table. Each object in the array should align with the column definitions.',
            table: {
                type: { summary: 'T[]' },
            }
        },
        stickyHeader: {
            control: 'boolean',
            description: 'If `true`, the table header will remain fixed at the top when scrolling. If `true`, make sure to set table maxHeight.',
            table: {
        ...
        maxHeight: {
            control: 'text',
            description: 'The maximum height of the table\'s scrollable area. Applies only when `stickyHeader` is `true`.',
            table: {
        ...
        selectedRows: {
            control: false,
            description: 'An array of indices for the selected rows. Enables controlled row selection.',
            table: {
                type: { summary: 'number[]' },
            }
        },
        onRowSelect: {
            action: false,
            description: 'Callback triggered when a row is selected or deselected. Provides the index of the row, its new selected state, and the updated selected rows array.',
            table: {
                type: { summary: '(row: number, value: boolean, selectedRows: number[]) => void' },
            }
        },
        sorting: {
            control: false,
            description: 'Initial sorting configuration. Defines the key to sort by and the direction (`asc`, `desc`, or `null`).',
            table: {
        ...
        onSort: {
            action: false,
            description: 'Callback triggered when a column header is clicked for sorting. Provides the new sorting configuration.',
            table: {
        ...
        rowClassName: {
            control: false,
            description: 'Function to determine the className of a row. Returns `string` to apply custom styling.',
            table: {
        ...
        rowStyle: {
            control: false,
            description: 'Function to determine the style of a row. Returns `CSSProperties` to apply custom styling.',
            table: {
        ...
        fullwidth: {
            control: 'boolean',
            description: 'If `true`, the table spans the full width of its container.',
            table: {
                defaultValue: { summary: 'false' },
                type: { summary: 'boolean' },
            },
        ...
        showSelected: {
            control: 'boolean',
            description: 'If `true`, includes a column for row selection with checkboxes.',
            table: {
                defaultValue: { summary: 'false' },
                type: { summary: 'boolean' },
            },
        ...
        verticalAlign: {
            ...
            description: 'Controls the vertical alignment of cell content. Defaults to `top`.',
            table: {
...
const data = [
    ...
    { id: 6, name: 'Oliver', email: 'oliver@example.com', age: 42, gender: 'male', country: 'USA' },
    { id: 7, name: 'Sophia', email: 'sophia@example.com', age: 22, gender: 'female', country: 'UK' },
    { id: 8, name: 'Liam', email: 'liam@example.com', age: 33, gender: 'male', country: 'India' },
    { id: 9, name: 'Emma', email: 'emma@example.com', age: 44, gender: 'female', country: 'USA' },
    { id: 10, name: 'Noah', email: 'noah@example.com', age: 32, gender: 'male', country: 'India' },
];
