...
export const DefaultValue: Story = {
    ...
    render: (args) => {
        ...
        return (
            <Checkbox {...args} inputRef={InputRef} />
        );
    },
    argTypes: {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a uncontrolled Checkbox. to access the input field and its value, use the inputRef.',
            },
            source: {
                code: `
...
export const ControlledValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a controlled Checkbox with internal state using useState.',
            },
            source: {
                code: `
import { useState } from 'react';
