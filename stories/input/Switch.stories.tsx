...
const meta: Meta<SwitchProps> = {
    ...
    argTypes: {
        ...
        trueLabel: {
            control: 'text',
            description: 'The label to display when the switch is in the "on" or "checked" state.',
            table: {
                type: { summary: 'string' },
            },
        },
        falseLabel: {
            control: 'text',
            description: 'The label to display when the switch is in the "off" or "unchecked" state.',
            table: {
                type: { summary: 'string' },
            },
        },
...
export const DefaultValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a uncontrolled Switch. to access the input field and its value, use the inputRef.',
            },
            source: {
                code: `
...
export const ControlledValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a controlled Switch with internal state using useState.',
            },
            source: {
                code: `
import { useState } from 'react';
