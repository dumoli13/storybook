...
export const Playground: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'Select components are used for collecting user provided information from a list of options.',
            },
        },
    },
};
...
export const DefaultValue: Story = {
    ...
    render: (args) => {
        ...
        return (
            <Select {...args} options={options} inputRef={InputRef} />
        );
    },
    argTypes: {
        value: { control: false },
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a uncontrolled Select. to access the input field and its value, use the inputRef.',
            },
            source: {
                code: `
...
export const ControlledValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a controlled Select with internal state using useState.',
            },
            source: {
                code: `
import { useState } from 'react';
...
export const WithIcon: StoryObj<WithIconControls> = {
    ...
    render: (args) => {
        ...
        return <Select {...rest} startIcon={start} endIcon={end} options={options} />;
    },
};