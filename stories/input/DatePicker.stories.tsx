...
import { DatePicker, DatePickerProps, InputDatePickerRef, InputDateValue } from '../../src/components';
...
export const DefaultValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a uncontrolled DatePicker. to access the input field and its value, use the inputRef.',
            },
            source: {
                code: `
...
export const ControlledValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a controlled DatePicker with internal state using useState.',
            },
            source: {
                code: `
import { useState } from 'react';
