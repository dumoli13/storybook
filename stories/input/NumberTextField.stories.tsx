...
const meta: Meta<NumberTextFieldProps> = {
  ...
  argTypes: {
    ...
    initialValue: {
      control: 'number',
      description:
        ' 4444  The initial value of the input when default value or value isnot provided. This is useful when user want to reset field/form and it will return to initial value',
      table: {
        type: { summary: 'string | number' },
      },
    },
...
export const DefaultValue: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This story demonstrates a uncontrolled NumberTextField. to access the input field and its value, use the inputRef.',
      },
      source: {
        code: `
