...
import { Icon, IconNames, PasswordField, PasswordFieldRef, type PasswordFieldProps } from '../../src/components';
...
export const DefaultValue: Story = {
    ...
    render: (args) => {
        ...
        return (
            <PasswordField {...args} inputRef={InputRef} />
        );
    },
    argTypes: {
        value: { control: false },
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a uncontrolled PasswordField. to access the input field and its value, use the inputRef.',
            },
            source: {
                code: `
...
export const ControlledValue: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: 'This story demonstrates a controlled PasswordField with internal state using useState.',
            },
            source: {
                code: `
import { useState } from 'react';
