...
import RichTextField2 from '../../src/components/Inputs/RichTextField2';
import { RichTextFieldProps } from '../../src/components/Inputs/RichTextField';
...
const meta: Meta<RichTextFieldProps> = {
    title: 'Input/RichTextField2',
    component: RichTextField2,
    tags: ['autodocs'],
    argTypes: {
        value: {
            control: 'text',
