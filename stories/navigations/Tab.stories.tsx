...
import { TabProps, Tab } from '../../src/components';
...
const meta: Meta<TabProps> = {
    ...
    argTypes: {
        items: {
            control: 'object',
            description: 'An array of tab items, each containing the following properties:',
            table: {
                type: { summary: 'Array<{ key: string, label: string, children: ReactNode , disabled?: boolean }>' },
            }
        },
        defaultActiveKey: {
            control: 'text',
